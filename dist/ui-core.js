...
/***/ function(module, exports, __webpack_require__) {
	...
	var _container = new (Backbone.Model.extend({
	    ...
	    setFormat: function setFormat() {
	        ...
	        if (win_width >= 1360) format = 'xdesktop';else if (win_width >= 1180 && win_width <= 1359) format = 'desktop';else if (win_width >= 1024 && win_width <= 1179) format = 'tablet';else if (win_width >= 768 && win_width <= 1023) format = 'tablet-portrait';else if (win_width >= 480 && win_width <= 767) format = 'handset';else if (win_width <= 479) format = 'handset-portrait';
	...
	window.ui = {
	    ...
	    _components: {},
	    component: function component(addon) {
	        var _component;

	        typeof addon == 'function' && (_component = new addon(this));
	        (typeof addon === "undefined" ? "undefined" : _typeof(addon)) == 'object' && (_component = addon);
	        ...
	        } else console.error("Error initialization of the component.", _component);
	    }
	};
